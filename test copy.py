...
class ImageStitcherNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('pano_width_multiplier', 0.8) # 全景图宽度乘数
        ...
        self.declare_parameter('refine_update_interval', 8)  # 每多少帧尝试一次新的细化
    ...
    def image_callback(self, ros_img0_msg, ros_img1_msg):
        ...
        try:
            ...
            stitched_image = pano0.astype(np.float32) * w0 + pano1.astype(np.float32) * w1
